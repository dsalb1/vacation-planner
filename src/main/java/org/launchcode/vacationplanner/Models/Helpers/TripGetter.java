...
public class TripGetter {
    ...
    public Iterable<Trip> getByCookie(UserDao userDao, HttpServletRequest request) {
    ...
    public Iterable<Trip> getBySession(UserDao userDao, HttpServletRequest request) {
